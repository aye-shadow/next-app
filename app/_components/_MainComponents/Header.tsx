...
const Header = () => {
  return (
    <nav className="flex justify-between bg-slate-00 relative py-4 px-16 pb-8">
      <Link
        href="../"
        className="font-bold font-serif pt-4 cursor-pointer"
      >
        Ecommerce
      </Link>
      ...
      {/* shopping cart */}
      <span className="cursor-pointer bg-black flex align-middle text-white px-7 rounded-xl pt-2 gap-2 text-sm mt-1">
        <p>0</p>
